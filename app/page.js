    ...
    <section className="mx-auto grid max-w-7xl grid-cols-1 gap-16 px-6 py-28 md:grid-cols-2">
      <div>
        ...
        <p className="mt-6 text-zinc-400">
          Capture, qualify, and convert leads using AI routing, Stripe billing,
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-28">
      ...
      <p className="mt-4 text-zinc-400">
        NorthSky prioritizes high-value leads and triggers automated conversion workflows instantly.
      </p>
    </section>
  );
}
...
/* ================= ANALYTICS ================= */
function Analytics({ revenueData, leadData }) {
  return (
    <section className="mx-auto max-w-7xl px-6 py-28">
...
function Chart({ type, dataKey, data }) {
  return (
